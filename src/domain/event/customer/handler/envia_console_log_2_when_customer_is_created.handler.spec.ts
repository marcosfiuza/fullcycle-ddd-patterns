...
import EnviaConsoleLog2WhenCustomerIsCreatedHandler from "./envia_console_log_2_when_customer_is_created.handler";

describe("Envia console log 1 when customer is created handler unit test", () => {
    it("should notify when user is created", () => {
        const eventDispatcher = new EventDispatcher();
        const eventHandler = new EnviaConsoleLog2WhenCustomerIsCreatedHandler();
